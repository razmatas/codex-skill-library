---
name: framer-project-kFuHhQhO9BaxXsHYFc98
description: "Project-scoped Framer skill for project kFuHhQhO9BaxXsHYFc98. Covers project reads, edits, change review, publishing, image sourcing, component operations, and canvas editing. Very important: never load this skill without having already read the `framer` skill and without having already run `session new`, which will dynamically update this skill."
allowed-tools: ["Bash(npx @framer/agent:*)", "Bash(npx @framer/agent@latest:*)", "Read(/var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/*)", "Write(/var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/*)"]
---

## Project Scope

- Project ID: kFuHhQhO9BaxXsHYFc98
- Generated At: 2026-06-21T11:53:40.917Z
...
Only after checking docs, use your write tool to write your code to a unique file under `/var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/`, then execute it with `-f`. Do not create code files with shell heredocs or `cat`. Name each file `<sessionId>-<short-summary>.js` where `<short-summary>` is a brief kebab-case description (e.g., `1-read-collections.js`, `1-add-team-member.js`).

```bash
npx @framer/agent@latest exec -s 1 -f /var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/1-read-collections.js
```
...
```js
// /var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/1-get-collections.js
state.collections = await framer.getCollections();
```

```bash
npx @framer/agent@latest exec -s 1 -f /var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/1-get-collections.js
```

```js
// /var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/1-get-team-items.js — reuse from state
state.teamItems = await state.collections.find(c => c.name === 'Team').getItems();
console.log(state.teamItems.length);
```

```bash
npx @framer/agent@latest exec -s 1 -f /var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/1-get-team-items.js
```
...
Prefer using your write tool to write code to a unique file under `/var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/` and executing it with `-f`. Do not create code files with shell heredocs or `cat`:

```bash
npx @framer/agent@latest exec -s <sessionId> -f /var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/<sessionId>-<short-summary>.js
```
...
state.localCodePath = "/var/folders/cn/vx5jnfyn6dd2wq_h5cws1_cm0000gn/T/framer/Badge.tsx";
...
+FileVariable <Unique identifier for the variable> name="<Name of the variable>" scope="<Unique identifier of the scope node to create the variable in>" allowedFileTypes="<Array of allowed file extensions, e.g. .mp3 or .mp4>";
...
+GalleryVariable <Unique identifier for the variable> name="<Name of the variable>" scope="<Unique identifier of the scope node to create the variable in>" minCount="<Optional - Minimum number of images in the gallery>" maxCount="<Optional - Maximum number of images in the gallery>";
+CollectionReferenceVariable <Unique identifier for the variable> name="<Name of the variable>" type="<single | multi>" collection="<Referenced collection name>" scope="<Unique identifier of the scope node to create the variable in>";
...
Use `+Variable` to create standard variables. Use `+DateVariable`, `+OptionVariable`, `+EventHandlerVariable`, `+FileVariable`, `+GalleryVariable`, `+CollectionReferenceVariable`, `+LinkVariable`, and `+IconVariable` for their specialized syntaxes.
...
Example Images: <image-attachments>["https://framerusercontent.com/assets/9nfnlHB3O5VQP9oeRwyvi7ztrE.png","https://framerusercontent.com/assets/ApXnpSn7KTqRCzLmeQs9psd1fSU.png","https://framerusercontent.com/assets/ArrUzY8CZC2i6zL1BT8FMm3Mg1k.png"]</image-attachments>
...
Example Images: <image-attachments>["https://example.com/footer-reference.png"]</image-attachments>
...
[{"name":"liquid-gradient","title":"Liquid Gradient","keywords":"shader gradient liquid blob organic"},{"name":"holo","title":"Holo","keywords":"shader holo"},{"name":"wave-gradient","title":"Wave Gradient","keywords":"shader gradient wave flowing ocean"},{"name":"bands","title":"Bands","keywords":"shader bands stripes"},{"name":"rings","title":"Rings","keywords":"shader rings circles concentric"},{"name":"blockify","title":"Blockify","keywords":"shader blocks blockify"},{"name":"pixels","title":"Pixels","keywords":"shader pixels"},{"name":"truchet","title":"Truchet","keywords":"shader truchet pattern tiles geometric"},{"name":"fluted-glass","title":"Fluted Glass","keywords":"shader glass fluted"},{"name":"mesh","title":"Mesh","keywords":"shader mesh gradient animated"},{"name":"particles","title":"Particles","keywords":"shader particles stars space dots hyperspace warp travel"},{"name":"chromatic-aberration","title":"Chromatic Aberration","keywords":"shader chromatic aberration"},{"name":"logo-gradient","title":"Logo Gradient","keywords":"shader logo gradient"},{"name":"logo-glass","title":"Logo Glass","keywords":"shader logo glass metallic chrome dispersion"},{"name":"logo-spectrum","title":"Logo Spectrum","keywords":"shader logo spectrum metal"},{"name":"logo-crystal","title":"Logo Crystal","keywords":"shader logo crystal glass refraction"}]
</available-shaders>

<additional-context>
{"userName":"Razif Djamaludin","currentDate":"June 21, 2026","timeZone":"America/New_York"}
</additional-context>
